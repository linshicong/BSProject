package com.linshicong.bsproject.view.SplashView;
...
public class LauncherView extends RelativeLayout {
    ...
    private void showLogo() {
        ...
        final View ll=view.findViewById(R.id.ll);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ObjectAnimator alpha = ObjectAnimator.ofFloat(ll, View.ALPHA, 1f, 1f);
                alpha.start();
            }
        },800);
    }
